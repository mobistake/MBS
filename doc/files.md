...
mbs.conf           | contains configuration settings for mbsd or mbs-qt
mbsd.pid           | stores the process id of mbsd while running
...
debug.log           | contains debug information and general logging generated by mbsd or mbs-qt
