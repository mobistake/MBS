...
/* Mobistake GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Mobistake"
#define QAPP_ORG_DOMAIN "mobistake.app"
#define QAPP_APP_NAME_DEFAULT "Mobistake-Qt"
#define QAPP_APP_NAME_TESTNET "Mobistake-Qt-testnet"
