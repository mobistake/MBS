...
/** Utility functions used by the Mobistake Qt UI.
 */
namespace GUIUtil
{
...
// Render MBS addresses in monospace font
...
// Parse "mbs:" URI into recipient object, return true on successful parsing
