...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all MBS specific functionality (Masternodes) (0-1, default: %u)"), 0));
