...
DefaultDirName={autopf}\Mobistake
...
OutputDir=.\output
OutputBaseFilename=MobistakeSetup
...
DefaultGroupName=Mobistake Core
...
[Files]
Source: ".\package\mbs-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Mobistake\Mobistake-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Mobistake\Mobistake-Qt,strDataDir|{userappdata}\Mobistake\}');
  Result := True;
end;
