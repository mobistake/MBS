...
* Fill in the following data:
    * Application Name: `Mobistake Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2024 Mobistake Core Developers`
    * Application Website: `https://mobistake.app/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Mobistake`
* Add application files:
    * Select the file `mbs-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `mbs-2.0.0-win64-setup.exe`
