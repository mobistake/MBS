...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mbs.conf'
CONFIGFOLDER='/root/.mbs'
COIN_DAEMON='mbsd'
COIN_CLI='mbs-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Mobistake/Mobistake/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
