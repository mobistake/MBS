...
"""Verify that starting mbs with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mbs with -? for help text")
        ...
        self.log.info("Start mbs with -version for version information")
