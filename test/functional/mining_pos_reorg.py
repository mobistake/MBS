...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected MBS supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check MBS supply at the beginning
        # ------------------------------------------
        ...
        # Verify that MBS supplies were properly updated after the spends and reorgs
        self.log.info("Check MBS supply...")
