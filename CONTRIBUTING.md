Contributing to Mobistake Core
============================

The Mobistake Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mobistake/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Mobistake Core project, and is not to be
confused with overall Mobistake Network Protocol consensus changes.

Whether a pull request is merged into Mobistake Core rests with the project merge
...
Patches that change Mobistake consensus rules are considerably more involved than
...
Where a patchset proposes to change the Mobistake consensus, it must have been
...
The project leader is the release manager for each Mobistake Core release.
